...
export const DEFAULT_TTS_OPTIONS = {
  ...
  voxcpm2_identities: [
    ...
    { value: 'young_man', label: 'Young man' },
    { value: 'adult_woman', label: 'Adult woman' },
    { value: 'adult_man', label: 'Adult man' },
    { value: 'middle_aged_woman', label: 'Middle-aged woman' },
    { value: 'middle_aged_man', label: 'Middle-aged man' },
    { value: 'elderly_woman', label: 'Elderly woman' },
    { value: 'elderly_man', label: 'Elderly man' },
  ],
  voxcpm2_textures: [
    { value: '', label: '(none)' },
    { value: 'calm_and_balanced', label: 'Calm and balanced' },
    { value: 'gentle_and_warm', label: 'Gentle and warm' },
    { value: 'soft_and_measured', label: 'Soft and measured' },
    { value: 'clear_and_articulate', label: 'Clear and articulate' },
    { value: 'low_and_resonant', label: 'Low and resonant' },
    { value: 'bright_and_energetic', label: 'Bright and energetic' },
    { value: 'warm_and_intimate', label: 'Warm and intimate' },
    { value: 'breathy_and_quiet', label: 'Breathy and quiet' },
    { value: 'enthusiastic_and_dynamic', label: 'Enthusiastic and dynamic' },
    { value: 'slow_and_reflective', label: 'Slow and reflective' },
  ],
  voxcpm2_presets: [
    { value: '', label: '(none)' },
    { value: 'song_piano_sad', label: 'Song · sad piano' },
    { value: 'song_pop_happy', label: 'Song · happy pop, passionate' },
    { value: 'song_acoustic_calm', label: 'Song · calm acoustic' },
  ],
