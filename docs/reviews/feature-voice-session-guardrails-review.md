...
Review `feature/voice-session-guardrails` against `main`. Review only; do not
modify the branch.
...
The author run passed 264 Python tests and 91 JavaScript tests. Inspect the full
